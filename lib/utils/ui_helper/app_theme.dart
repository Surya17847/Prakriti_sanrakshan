...
class AppColors {
  ...
  static const Color primaryColor = Color(0xFF11FF4D); // Red for primary buttons, highlights, or notifications
  static const Color secondaryColor = Color(0xFF1FB3B3); // Soft Pink for secondary buttons or accents
  ...
  static const Color buttonSecondaryColor = Color.fromARGB(155, 55, 238, 138); // Soft pink for secondary button
